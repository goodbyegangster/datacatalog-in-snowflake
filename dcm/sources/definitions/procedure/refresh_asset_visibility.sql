...
define procedure {{ sis_database_name }}.PROCEDURE.REFRESH_ASSET_VISIBILITY()
    returns string
    language sql
    execute as owner
as
$$
begin
    create or replace table {{ sis_database_name }}.CATALOG.ASSET_VISIBILITY (
    ...
    with recursive reach as (
        ...
        from {{ sis_database_name }}.CATALOG.ACCESS_EDGES as e
        ...
        select
            ...
            r.first_role
        from reach as r
        inner join {{ sis_database_name }}.CATALOG.ACCESS_EDGES as e
